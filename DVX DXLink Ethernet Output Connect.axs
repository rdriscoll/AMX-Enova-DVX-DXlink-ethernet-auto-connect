MODULE_NAME='DVX DXLink Ethernet Output Connect' (DEV dvSwitcherPort, DEV dvDXLink) // dvSwitcherPort (eg 5002:6:0), dvDXLink (eg 15201:01:0)
(***********************************************************)
(* System Type : NetLinx                                   *)
(***********************************************************)
(* REV HISTORY:                                            *)
...
(*
	20121026 v0.1 RRD
	 Automatically connect a DXLink Rx device to a DVX.
*)    
(***********************************************************)
...
TIMELINE_EVENT[TL_DXLINK_ONLINE]
{
	...
	ELSE
	{
		IF(TIMELINE.SEQUENCE == 1)
			SEND_COMMAND dvSwitcherPort,'dxlink_eth-off';
		ELSE
			SEND_COMMAND dvSwitcherPort,'dxlink_eth-auto';
	}
